...
output: 
  vetiver::vetiver_dashboard:
    pins:
      board: !expr pins::board_url(c(seattle_model = "https://colorado.posit.co/rsc/seattle-rstats-model-pin/"))
      name: 'seattle_model'
      version: NULL
    storyboard: true
    theme: 
...
knitr::include_url("https://colorado.posit.co/rsc/seattle-housing-rstats/", height = "600px")
```
