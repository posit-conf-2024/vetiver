...
v = VetiverModel(housing_fit, "user.name/chicago-inspections-python", prototype_data = X_train)
...
```{r}
url <- "https://colorado.posit.co/rsc/seattle-housing-rstats/metadata"
r <- httr::GET(url)
...
url = "https://colorado.posit.co/rsc/seattle-housing-python/metadata" 
